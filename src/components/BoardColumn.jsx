...
function BoardColumn({ title, tasks, status, onUpdate, onDelete, isOver, isDragging }) {
  ...
  return (
    <div
      ref={setNodeRef}
      className={`flex-1 min-w-0 ${bgColor} border-2 rounded-2xl p-4 transition-all duration-200 ${
        isOver
    ...
    >
      {/* Indicador superior */}
      {isOver && (
        <div className="mb-3 flex items-center justify-center animate-bounce">
